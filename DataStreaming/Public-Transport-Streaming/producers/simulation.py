...
logging.config.fileConfig('/home/yannick/Documents/DataStreaming/Public-Transport-Streaming/producers/logging.ini')
...
class TimeSimulation:
    ...
    def __init__(self, sleep_seconds=5, time_step=None, schedule=None):
        ...
        self.raw_df = pd.read_csv(
            '/home/yannick/Documents/DataStreaming/Public-Transport-Streaming/producers/data/cta_stations.csv'
